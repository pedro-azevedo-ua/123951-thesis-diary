# Project Notebook: Evolution and Weekly Progress

---
## Project Introduction

**Project Title:** The Playground: Mobile platform to connect amateur basketball players
**Author:** Pedro Azevedo
**Student ID:** 123951

---
## Before Classes (Before 15 September 2025)

**Initiation:**
- Drafted an initial survey targeting basketball players to assess court usage and main challenges.
- Designed and distributed flyers (in both Portuguese and English) to promote the survey.
- Explored mobile development approaches (Native, Cross-platform, Multiplatform), documented pros/cons, and started reading "Kotlin in Depth Coroutines, Compose, Multiplatform Apps for Android and Beyond".
...
- Initiated competitor analysis and began analyzing initial survey results.
- Started reading and documenting insights from "Kotlin in Depth" for multiplatform technologies.
...
- Explored different ways of developing mobile applications
